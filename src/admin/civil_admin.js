...
import {deletecivilLaws} from '../firebaseConfig'
const db = firebase.database();
class civil_admin extends Component {
    constructor(props) {
        super(props);
        this.state = {
            laws : [],
    ...
    deletecivil(el){
        let del = deletecivilLaws(el._id);
        alert('law deleted sucessfully');
        this.getData()
    }

    addLaw(){
        this.props.history.push('/civil_LawAdd');
    }
                                ...
                                <div class="container">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <p><span> <b>Section No : </b> </span> {el.section_no}</p>
                                                ...
                                                <button type="button" class="btn btn-success" onClick= {()=>{this.deletecivil(el)}}>Delete</button>
                                                <hr/>
